...
using Axxiom.Linq.Dynamic.Core.Parser;

namespace Axxiom.Linq.Dynamic.Core
{
    /// <summary>
    /// Configuration class for Axxiom.Linq.Dynamic.Core.
    /// </summary>
    public class ParsingConfig
    {
        ...
        //public string CustomTypesPrefix { get; set; }

        //public bool HasCustomTypesPrefix => !string.IsNullOrWhiteSpace(CustomTypesPrefix);

        public bool TryResolveTypeFromCustomTypeProvider { get; set; } = false;
        public bool TryResolveTypeFromExpression { get; set; } = true;
    }
}
