...
using Axxiom.Linq.Dynamic.Core.Validation;
...
namespace Axxiom.Linq.Dynamic.Core
{
    ...
    public static class DynamicClassFactory
    {
        ...
        private static string DynamicAssemblyName = "Axxiom.Linq.Dynamic.Core.DynamicClasses, Version=1.0.0.0";
        private static string DynamicModuleName = "Axxiom.Linq.Dynamic.Core.DynamicClasses";
