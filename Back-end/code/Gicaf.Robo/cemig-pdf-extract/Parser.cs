...
namespace cemig_pdf_extract
{
    class Parser
    {
        ...
        public List<ModelOutput> Parse(string file)
        {
            var reader = new PdfReader(File.ReadAllBytes(file));
        ...
        public void PdfToText(string pdf, string output)
        {
            var reader = new PdfReader(File.ReadAllBytes(pdf));
