...
namespace Gicaf.Linq.Dynamic.Core
{
    ...
    public static class DynamicClassFactory
    {
        ...
        private static string DynamicAssemblyName = "Gicaf.Linq.Dynamic.Core.DynamicClasses, Version=1.0.0.0";
        private static string DynamicModuleName = "Gicaf.Linq.Dynamic.Core.DynamicClasses";
